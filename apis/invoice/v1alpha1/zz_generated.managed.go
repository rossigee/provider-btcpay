...
func (mg *Invoice) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this Invoice.
func (mg *Invoice) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *Invoice) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this Invoice.
func (mg *Invoice) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
