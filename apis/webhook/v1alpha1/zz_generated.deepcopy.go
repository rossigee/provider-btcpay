...
func (in *WebhookObservation) DeepCopyInto(out *WebhookObservation) {
	*out = *in
	if in.AuthorizedEvents != nil {
		in, out := &in.AuthorizedEvents, &out.AuthorizedEvents
...
func (in *WebhookParameters) DeepCopyInto(out *WebhookParameters) {
	*out = *in
	...
	if in.AutomaticRedelivery != nil {
		in, out := &in.AutomaticRedelivery, &out.AutomaticRedelivery
		*out = new(bool)
		**out = **in
	}
	if in.Secret != nil {
